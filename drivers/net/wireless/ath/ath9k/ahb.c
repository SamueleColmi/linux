...
const struct of_device_id of_ath_ahb_match[] = {
	{
		...
		.data = &of_ath_ahb_data[AR913X_WMAC]
	},
	{
		.compatible = "qca,ar9330-wmac",
		.data = &of_ath_ahb_data[AR933X_WMAC]
	},
	{
		.compatible = "qca,ar9340-wmac",
		.data = &of_ath_ahb_data[AR934X_WMAC]
	},
	{
		.compatible = "qca,qca9530-wmac",
		.data = &of_ath_ahb_data[QCA953X_WMAC]
	},
	{
		.compatible = "qca,qca9550-wmac",
		.data = &of_ath_ahb_data[QCA955X_WMAC]
	},
	{
		.compatible = "qca,qca9560-wmac",
		.data = &of_ath_ahb_data[QCA956X_WMAC]
	},
	{},
};
